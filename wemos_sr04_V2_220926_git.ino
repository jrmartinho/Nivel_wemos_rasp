 ...
 **
 ** Versao 2.0 - 10/09/2022 (em desenvolvimento...)
 ** Melhoria na configuração pela web, ticks no grafico svg
 ** 
 ** Versao 2.0 - 26/09/2022 (em desenvolvimento...)
 ** Correcao no envio da terceira variavel (num_medida) para o Thingspeak
 ** Linha de ajuda para "get no browser" na pagina /configura
 ** 
 *=========================================================================================
 */
#define firmware_versao "Versao 2.0 - 26/09/2022 21:00"
...
String writeAPIKey="preencher";     // Change this to the write API key for your channel.
...
//         bool simula = false;
  ...
  message += ajuda;
  message += "\n-----------------------------------------\n";
  message += "  http://IP/configura?simula=1&ajuda=1  \n";
  message += "\n-----------------------------------------\n\n";
...
const char* resource = "/update?api_key=";
  ...
  client.print(String("GET ") + resource + writeAPIKey + "&field1=" + fieldData[0] +
                  "&field2=" + fieldData[1] + "&field3=" + fieldData[2] +
                  " HTTP/1.1\r\n" +
